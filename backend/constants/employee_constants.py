class BotMessages:
    # register messages
    register = "همکار گرامی، سلام\n به بات منابع انسانی شرکت توس‌رادیه خوش آمدید.برای استفاده از خدمات لطفا ثبت‌نام کنید."
    first_name = "لطفا نام خود را وارد کنید."
    full_name = 'لطفا *نام و نام‌خانوادگی* خود را وارد کنید.'
    employee_id = "لطفا شماره پرسنلی خود را وارد کنید."
